...
<div id="hero_section">
    <div id="filtre" class="hero_section_item">
        ...
        <h4 class="sous_titre_filtre" id="categorie_filtre">Catégories</h4>
            <p class="section_filtre"> Maternelle </p>
            <p class="section_filtre"> Primaire </p>
            <p class="section_filtre"> Secondaire </p>
            <p class="section_filtre"> Haute Ecole </p>
            <p class="section_filtre"> Université </p>


        <h4 class="sous_titre_filtre" id="theme_filtre">Thèmes</h4>
            <p class="section_filtre">Mathématique </p>
            <p class="section_filtre">Science</p>
            <p class="section_filtre">Français</p>
            <p class="section_filtre">Histoire</p>
            <p class="section_filtre">EPS</p>
            <p class="section_filtre">Géographie</p>
            <p class="section_filtre">Langues</p>
            <p class="section_filtre">Religions</p>
   </div>
    ...
    <div id="produits" class="hero_section_item">
        ...
        <div class="bloc_produit">
            <div class="bloc_image" onclick="window.location.href='index.php?page=produit';" style="cursor: pointer;"></div>
            <p>
